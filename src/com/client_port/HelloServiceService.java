 ...
 * 
 */
@WebServiceClient(name = "HelloServiceService", targetNamespace = "http://service_port.com/", wsdlLocation = "http://127.0.0.1:8000/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICESERVICE_QNAME = new QName("http://service_port.com/", "HelloServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:8000/hello?wsdl");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://service_port.com/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service_port.com/", "HelloServicePort"), HelloService.class, features);
    }
