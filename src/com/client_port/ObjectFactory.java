 ...
 * generated in the com.client_port package. 
...
public class ObjectFactory {
    ...
    private final static QName _GreetingResponse_QNAME = new QName("http://service_port.com/", "GreetingResponse");
    private final static QName _Greeting_QNAME = new QName("http://service_port.com/", "Greeting");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.client_port
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service_port.com/", name = "GreetingResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service_port.com/", name = "Greeting")
